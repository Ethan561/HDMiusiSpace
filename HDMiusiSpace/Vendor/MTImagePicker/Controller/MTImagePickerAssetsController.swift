...
class MTImagePickerAssetsController :UIViewController,UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.leadingCons.constant = self.collectionView.leading.constant
        cell.trailingCons.constant = self.collectionView.leading.constant
        cell.topCons.constant = self.collectionView.leading.constant * 2
        return cell
    }
