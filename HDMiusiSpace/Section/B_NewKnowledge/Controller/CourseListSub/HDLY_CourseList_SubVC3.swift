...
//        audioPlayer.delegate = self
    ...
    func dataRequest()  {
        ...
        HD_LY_NetHelper.loadData(API: HD_LY_API.self, target: .courseQuestionList(skip: "0", take: "100", api_token: TestToken, id: idnum), showHud: false, loadingVC: self, success: { (result) in
